...
{
    /// <summary/>
    [ProblemSolver("Problem 11", displayName = "Problem 11", problemDefinition =
...
What is the greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally) in the 20×20 grid?")]
    public class EulerProblem11 : AbstractEulerProblem
    {
        protected override void Solve(out string answer)
        {
            ...
            answer = string.Format("Greatest product of four adjacent numbers in the same direction (up, down, left, right, or diagonally) is {0}. Iterations: {1}.", totalMax, totalIterations);
        }
